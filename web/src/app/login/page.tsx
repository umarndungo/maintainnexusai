...
const accounts: Record<Role, { label: string; detail: string; email: string; password: string }> = {
  engineer: { label: "Engineer", detail: "Review signals and approve work", email: "engineer@maintainnexus.ai", password: "engineer-demo" },
  supervisor: { label: "Supervisor", detail: "Resolve escalations across stations", email: "supervisor@maintainnexus.ai", password: "supervisor-demo" },
  executive: { label: "Executive", detail: "See the value across the network", email: "executive@maintainnexus.ai", password: "executive-demo" },
};
...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState(accounts.engineer.email);
  const [password, setPassword] = useState(accounts.engineer.password);
